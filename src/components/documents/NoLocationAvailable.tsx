...
const NoLocationAvailable = ({ isLoading }: NoLocationAvailableProps) => {
  return (
    <div className="md:col-span-12 lg:col-span-12 bg-muted/40 dark:bg-muted/10 rounded-lg p-8 text-center">
      {isLoading ? (
        ...
        <>
          <h3 className="text-lg font-medium mb-2 text-foreground">No locations available</h3>
